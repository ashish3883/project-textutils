...
export default function Textform(props) {
  ...
  return (
    ...
    <div className="container" style={{color:props.mode==='light'?'#333333':'white'}}>
            ...
            <button className={`btn btn-${props.mode==='dark'?'secondary':'primary'} mx-1`} onClick={handelUpClick} >Convert to Uppercase</button>
            ...
            <button className={`btn btn-${props.mode==='dark'?'secondary':'primary'} mx-1`} onClick={handleExtraSpace}>Remove Extra Spaces</button>
    </div>
    <div className="container" style={{color:props.mode==='light'?'#333333':'white'}}>
